...
Flat.create!(
  name: 'Grand & Spacious Suite London',
  address: 'Hill Street, London W1J',
  description: 'Remarkable flat in a prime West End location with a vibrant lifestyle day & night',
  price_per_night: 200,
  number_of_guests: 2
)
